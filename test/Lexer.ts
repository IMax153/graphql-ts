...
// import { error, success } from 'parser-ts/lib/ParseResult'
...
//   describe('string', () => {
//     it('should disallow uncommon control characters', () => {
//       const a = '\u0007'
//       assert.deepStrictEqual(run(L.string, a), error(stream(a.split(''), 0), ['"""'], false))
//     })
